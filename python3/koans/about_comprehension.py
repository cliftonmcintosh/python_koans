...
class AboutComprehension(Koan):
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual(1 * 'lumberjack', comprehension[0])
        self.assertEqual(4 * 'spam', comprehension[2])
    ...
    def test_double_list_comprehension(self):
        ...
        self.assertEqual('{0} and {1}'.format('poached egg', 'lite spam'), comprehension[0])
